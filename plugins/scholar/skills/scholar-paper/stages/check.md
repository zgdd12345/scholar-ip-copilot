...
1. **Citation audit.** Drive via `../../.evidraft-private/capabilities/evidence/bib-manager/spec.md`:
...
2. **LaTeX compile.** Drive via `../../.evidraft-private/capabilities/latex/latex-build/spec.md`. Use the `latex-editor` subagent to triage any compile errors before continuing:
...
3. **Style audit.** Drive via `../../.evidraft-private/capabilities/latex/latex-style-audit/spec.md` (runs only when Step 2 is not `FAIL`):
...
4. **Bib quality audit.** Drive via `../../.evidraft-private/capabilities/evidence/bib-audit/spec.md` (runs after Step 1's `bib-manager` mechanics):
...
5. **Cross-reference audit.** Drive via `../../.evidraft-private/capabilities/latex/xref-audit/spec.md` (runs after Step 2's `latex-build` compile):
