...
roles in `../../.evidraft-private/roles/roles.yaml` and renders that role as the prompt,
...
**Spec home.** `../../.evidraft-private/capabilities/code/external-agent-bridge/spec.md` owns the CLI
...
2. `persona` occurs exactly once under a semantic role in `../../.evidraft-private/roles/roles.yaml`.
...
`../../.evidraft-private/capabilities/code/external-agent-bridge/spec.md` §CLI invocation matrix (one
...
2. **Render the prompt.** Follow `../../.evidraft-private/capabilities/code/external-agent-bridge/spec.md`
...
3. **Invoke the external agent.** Use the verbatim CLI signature for
   the chosen `agent` from `../../.evidraft-private/capabilities/code/external-agent-bridge/spec.md`
