...
- **Treating the chart as a patentability opinion.** It is reviewer convenience. The advisory paragraph in the capability specification "Advisory-only framing" section is not optional decoration.
