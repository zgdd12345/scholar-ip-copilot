...
phase: patent
description: >
  Load when workflow:patent.init, workflow:patent.scout, or workflow:patent.disclosure run. Provides
...
- existing `.evidraft/patent/invention_disclosure.md` template (from `workflow:patent.init`)
- `.evidraft/patent/invention_candidates.md` (from `workflow:patent.scout`)
