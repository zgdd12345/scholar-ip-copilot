...
kind: agent
phase: paper
allowed_tools: [Read, Glob, Grep, Write, Edit, "Bash:latexmk*", "Bash:cat*", "Bash:ls*"]
hooks: [latex-compile, citation-guard, evidence-consistency, sensitive-file-guard]
role: >
...
- `skills/venue-formatting/<venue>.yaml` if a venue conversion is active,
