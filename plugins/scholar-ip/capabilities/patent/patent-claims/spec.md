...
phase: patent
description: >
  Load when workflow:patent.claims or workflow:patent.review run. Provides claim anatomy
...
Dependent count: `workflow:patent.claims` defaults to 6 dependent claims; pick the 6 strongest narrowings, do not pad.
