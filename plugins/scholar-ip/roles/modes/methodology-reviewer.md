...
- Glob
- Grep
role: 'Cross-checks that the methodology described in the paper or invention disclosure is internally consistent with method_to_code.md, the equations, the experiment configurations, and any pseudocode. Owns the MISMATCH verdicts in paper_code_audit.md and the methodology section of patent_review_report.md.
