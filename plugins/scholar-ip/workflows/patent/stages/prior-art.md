...
1. **Collect.** Gather inputs:
   ...
   - patent rows fetched via `../../../capabilities/research/patent-search/spec.md` (URL templates, rate-limit policy, cache, and ethics disclaimer live in the skill),
   - academic rows fetched via `../../../capabilities/research/scholar-search/spec.md` for any adjacent papers.
