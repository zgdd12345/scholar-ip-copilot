...
2. **Structured audits when possible.** Use
   `../../../capabilities/patent/claim-parser/spec.md`,
   `../../../capabilities/patent/claim-chart-builder/spec.md`, and
   `../../../capabilities/patent/novelty-heuristics/spec.md` for the inputs they can
