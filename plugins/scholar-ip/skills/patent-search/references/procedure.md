...
Append a section to `.evidraft/patent/prior_art_map.md` per candidate invention. Always lead with the ethics disclaimer (copy from the block in SKILL.md). Then:
