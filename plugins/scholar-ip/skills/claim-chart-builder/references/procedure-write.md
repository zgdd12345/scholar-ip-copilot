...
Render `claim_chart.md` (markdown table per candidate; the SKILL.md "Advisory-only framing" paragraph at the end). Write `claim_chart-<ts>.json` next to it (schema in [schemas.md](schemas.md)).
