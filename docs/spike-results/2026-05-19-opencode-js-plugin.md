...
- **Production evidence:** superpowers 5.0.7 uses this key in `.opencode/plugins/superpowers.js:103-109` and works on the same OpenCode release family our local 1.3.0 belongs to. 14 published skills are discovered via this mechanism in real installs.
...
- **Verdict:** UNCLEAR — empirically supported by a 197k-star production plugin, but absent from the official type contract.
